  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={showsVerticalScrollIndicator} ref={this.verticalAgendaRef}>
          <View style={styles.scrollViewContent}>
            <Times is12HourFormat={is12HourFormat} times={times} textStyle={hourTextStyle} />
            <VirtualizedList
              data={initialDates}
              getItem={(data, index) => data[index]}
              getItemCount={(data) => data.length}
              ...
              keyExtractor={(item) => item}
              initialScrollIndex={this.pageOffset}
              scrollEnabled={scrollBetweenDate}
              renderItem={({ item }) => {
                return (
                  <Events
                    times={times}
...
WeekView.propTypes = {
  ...
  formatMonthHeader: PropTypes.string,
  ...
  scrollBetweenDate: PropTypes.bool,
